function CategorySection({ sectionTitle, children }: CategorySectionProps) {
  return (
    <section className="flex flex-col py-10 gap-5">
      ...
      <div className="no-scrollbar flex flex-col tablet:flex-row tablet:max-laptop:overflow-scroll laptop:flex-wrap tablet:gap-x-[20px] laptop:gap-x-[24px] gap-y-[30px]">
        {children}
      </div>
    </section>
  );
