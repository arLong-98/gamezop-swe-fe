...
function GameCard({ gameData, isSmall = false }: GameCardProps) {
  ...
  return (
    <div className="relative max-mobile:w-full tablet:max-laptop:min-w-[300px] laptop:w-[200px] largeLaptop:w-[417px] h-[278px] bg-blurGradient transition-all hover:scale-105 cursor-pointer">
